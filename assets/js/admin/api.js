...
function renderApiUI() {
    ...
    contentArea.innerHTML = `
        <div class="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-900 tracking-tight">API Providers</h2>
                <p class="text-sm text-slate-600 font-medium">Manage external SMM panel providers, rates, and catalog sync.</p>
            </div>
            <div class="w-full sm:w-auto flex flex-wrap gap-2">
                ...
                <button id="open-add-provider-modal" class="bg-brand-500 hover:bg-brand-600 text-white px-4 py-2.5 rounded-xl font-extrabold uppercase tracking-wider text-xs shadow-md border border-brand-600 transition-colors flex items-center gap-2 whitespace-nowrap cursor-pointer">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-slate-700 whitespace-nowrap">
                    <thead class="bg-slate-100 text-slate-800 border-b-2 border-slate-300 sticky top-0">
                        <tr>
                            <th class="px-6 py-4 font-bold text-xs uppercase tracking-wider w-48">Provider Name</th>
                            <th class="px-6 py-4 font-bold text-xs uppercase tracking-wider">API URL</th>
                            <th class="px-6 py-4 font-bold text-xs uppercase tracking-wider text-center w-32">Status</th>
                            <th class="px-6 py-4 font-bold text-xs uppercase tracking-wider text-right w-48">Actions</th>
                        </tr>
                    </thead>
                    <tbody id="admin-providers-table-body">
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-slate-500">
                                ...
                                <p class="font-bold">Loading API providers...</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
