    ...
    if (proxyRelayUrl) {
        try {
            ...
            try {
                ...
                console.warn(`[Worker] Proxy returned non-JSON. Falling back to direct...`);
            }
        } catch (proxyErr) {
            console.warn(`[Worker] Proxy error: ${proxyErr.message}. Falling back to direct...`);
        }
    }
...
/**
 * Netlify Scheduled Function (Maintenance & SaaS Engine)
...
// --- Task 1: Auto-Sync Provider Catalog (Runs daily) ---
...
// --- Task 2: Process Child Panel Subscriptions (Runs daily) ---
